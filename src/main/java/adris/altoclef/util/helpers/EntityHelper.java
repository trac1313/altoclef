...
public class EntityHelper {
    ...
    public static double calculateResultingPlayerDamage(PlayerEntity player, DamageSource source, double damageAmount) {
        ...
        if (!source.isIn(DamageTypeTags.BYPASSES_ARMOR)) {
            damageAmount = DamageUtil.getDamageLeft((float) damageAmount, null, (float) player.getArmor(), (float) player.getAttributeValue(EntityAttributes.GENERIC_ARMOR_TOUGHNESS));
        }
